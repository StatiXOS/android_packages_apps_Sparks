...
public class AccentPicker extends InstrumentedDialogFragment implements OnClickListener {
    ...
    private void initView() {
        ...
        Button userAccentTen = mView.findViewById(R.id.userAccentTen);
        setAccent("26", userAccentTen);

        Button userAccentEleven = mView.findViewById(R.id.userAccentEleven);
        setAccent("27", userAccentEleven);

        Button userAccentTwelve = mView.findViewById(R.id.userAccentTwelve);
        setAccent("28", userAccentTwelve);

        Button userAccentThirteen = mView.findViewById(R.id.userAccentThirteen);
        setAccent("29", userAccentThirteen);

		Button userAccentFourteen = mView.findViewById(R.id.userAccentFourteen);
        setAccent("30", userAccentFourteen);
    }
